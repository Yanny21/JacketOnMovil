...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/ChartComponent` | `/(tabs)/actEmp` | `/(tabs)/actividad` | `/(tabs)/asignaAct` | `/(tabs)/calidad` | `/(tabs)/calidadEmp` | `/(tabs)/detallesAct` | `/(tabs)/editAct` | `/(tabs)/editar` | `/(tabs)/editarEmp` | `/(tabs)/graficasyrep` | `/(tabs)/grafyrepEmp` | `/(tabs)/home` | `/(tabs)/metricas` | `/(tabs)/metricasGraf` | `/(tabs)/password` | `/(tabs)/passwordEmp` | `/(tabs)/porfile` | `/(tabs)/profile` | `/(tabs)/reporte` | `/(tabs)/styles` | `/ChartComponent` | `/_sitemap` | `/actEmp` | `/actividad` | `/asignaAct` | `/calidad` | `/calidadEmp` | `/detallesAct` | `/editAct` | `/editar` | `/editarEmp` | `/graficasyrep` | `/grafyrepEmp` | `/home` | `/login` | `/metricas` | `/metricasGraf` | `/password` | `/passwordEmp` | `/porfile` | `/profile` | `/registro` | `/reporte` | `/styles`;
