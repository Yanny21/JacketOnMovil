...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/actEmp` | `/(tabs)/actividad` | `/(tabs)/asignaAct` | `/(tabs)/calidad` | `/(tabs)/detallesAct` | `/(tabs)/editAct` | `/(tabs)/editar` | `/(tabs)/home` | `/(tabs)/password` | `/(tabs)/porfile` | `/(tabs)/reporte` | `/(tabs)/styles` | `/_sitemap` | `/actEmp` | `/actividad` | `/asignaAct` | `/calidad` | `/detallesAct` | `/editAct` | `/editar` | `/home` | `/login` | `/password` | `/porfile` | `/registro` | `/reporte` | `/styles`;
