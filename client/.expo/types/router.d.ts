...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/actEmp` | `/(tabs)/actividad` | `/(tabs)/asignaAct` | `/(tabs)/calidad` | `/(tabs)/detallesAct` | `/(tabs)/editAct` | `/(tabs)/editar` | `/(tabs)/graficasyrep` | `/(tabs)/grafyrepEmp` | `/(tabs)/home` | `/(tabs)/metricas` | `/(tabs)/metricasGraf` | `/(tabs)/password` | `/(tabs)/porfile` | `/(tabs)/reporte` | `/(tabs)/styles` | `/_sitemap` | `/actEmp` | `/actividad` | `/asignaAct` | `/calidad` | `/detallesAct` | `/editAct` | `/editar` | `/graficasyrep` | `/grafyrepEmp` | `/home` | `/login` | `/metricas` | `/metricasGraf` | `/password` | `/porfile` | `/registro` | `/reporte` | `/styles`;
