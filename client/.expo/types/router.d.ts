...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/actEmp` | `/(tabs)/actividad` | `/(tabs)/actividades` | `/(tabs)/asignaAct` | `/(tabs)/detallesAct` | `/(tabs)/editAct` | `/(tabs)/editar` | `/(tabs)/home` | `/(tabs)/metricas` | `/(tabs)/password` | `/(tabs)/porfile` | `/(tabs)/reporte` | `/(tabs)/styles` | `/_sitemap` | `/actEmp` | `/actividad` | `/actividades` | `/asignaAct` | `/detallesAct` | `/editAct` | `/editar` | `/home` | `/login` | `/metricas` | `/password` | `/porfile` | `/registro` | `/reporte` | `/styles`;
